...
public class MyCircle_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnstaticLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentStaticLocation = new Intent(MyCircle_Activity.this, StaticLocation_Activity.class);
                Bundle bundleStaticLocation = new Bundle();
                bundleStaticLocation.putString("circleName", nameCircle);
                intentStaticLocation.putExtras(bundleStaticLocation);

                startActivity(intentStaticLocation);
            }
        });
    }
    ...
    public void maps_Click(View view) {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("nameCircle", nameCircle);
        bundle.putString("userName", userName);
        intent.putExtras(bundle);
        startActivity(intent);
    }
